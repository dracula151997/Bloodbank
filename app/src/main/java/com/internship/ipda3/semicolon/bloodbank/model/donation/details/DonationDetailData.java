...
import com.internship.ipda3.semicolon.bloodbank.model.donation.request.City;

public class DonationDetailData {
    ...
    private DonationDetailClient mClient;
    ...
    public DonationDetailClient getClient() {
        return mClient;
    }

    public void setClient(DonationDetailClient client) {
        mClient = client;
    }
